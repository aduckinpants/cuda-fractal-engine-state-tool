...
class Phase1App:
    ...
    def _build(self) -> None:
        ...
        ttk.Button(button_row, text="Load Example Color Triplet", command=self._load_color_triplet).grid(row=0, column=3, sticky="ew", padx=2, pady=2)
        ttk.Button(button_row, text="Materialize", command=self._materialize).grid(row=0, column=4, sticky="ew", padx=2, pady=2)
        ttk.Button(button_row, text="Replay Prove", command=self._replay).grid(row=0, column=5, sticky="ew", padx=2, pady=2)
        ttk.Button(button_row, text="Copy Intake Packet", command=self._copy_intake).grid(row=0, column=6, sticky="ew", padx=2, pady=2)
