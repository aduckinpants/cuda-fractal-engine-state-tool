...
def build_finding_intake_packet(
    ...
    packet_text = "\n".join(
        [
            ...
            "- Help that says a control blends, scales, shapes, or colors a render signal is signal-processing authority,",
            "  not recurrence authority. A controlled comparison may prove visible contribution, but do not claim it changes",
            "  recurrence, orbit geometry, convergence, or underlying fractal morphology unless an engine-owned description",
            "  explicitly says the recurrence consumes it.",
