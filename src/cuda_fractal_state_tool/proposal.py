...
PATH_SPECS: dict[str, ProposalPathSpec] = {
    "color_pipeline_draft": ProposalPathSpec(
        ...
        accepted_values_source="Deployed compiled UI-Salt function-library contract plus engine-authoritative replay.",
        type_range_source="Bounded proposal_v1 lane/function selection shape and compiled UI-Salt ids.",
        pipeline_mapping_source="Engine --color-pipeline-action selection and engine-emitted complete draft.",
        runtime_or_source_provenance="runtime-authoritative: deployed UI-Salt contract and action-free replay",
    ),
